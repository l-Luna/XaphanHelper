...
namespace Celeste.Mod.XaphanHelper
{
    static class Achievements
    {
        public static List<AchievementData> GenerateAchievementsList(Session session)
        {
            ...
            list.Add(new AchievementData("upg4", 0, "WheresTheKaboom", "achievements/Xaphan/WheresTheKaboom", "Upgrade_Bombs", session.GetFlag("Upgrade_Bombs") ? 1 : 0, 1, 5));
            list.Add(new AchievementData("upg5", 0, "FeelingSpacey", "achievements/Xaphan/FeelingSpacey", "Upgrade_SpaceJump", session.GetFlag("Upgrade_SpaceJump") ? 1 : 0, 1, 5));
            ...
            list.Add(new AchievementData("strwb1", 1, "StrawberriesInTheRuins", "achievements/Xaphan/TheStrawberryHunt", "XaphanHelper_StatFlag_StrawberriesCh1", StatsFlags.CurrentStrawberries[1], StatsFlags.TotalStrawberries[1], 20));
            ...
            // Area 2
            list.Add(new AchievementData("gem2-1", 2, "FreeAtLast", "achievements/Xaphan/FreeAtLast", "XaphanHelper_StatFlag_GemCh2", session.GetFlag("XaphanHelper_StatFlag_GemCh2") ? 1 : 0, 1, 10));
            list.Add(new AchievementData("strwb2", 2, "StrawberriesInTheAbysses", "achievements/Xaphan/TheStrawberryHunt", "XaphanHelper_StatFlag_StrawberriesCh2", StatsFlags.CurrentStrawberries[2], StatsFlags.TotalStrawberries[2], 20));
            ...
            // Area 5
            list.Add(new AchievementData("strwb5", 5, "StrawberriesInTheTerminal", "achievements/Xaphan/TheStrawberryHunt", "XaphanHelper_StatFlag_StrawberriesCh5", StatsFlags.CurrentStrawberries[5], StatsFlags.TotalStrawberries[5], 20));
