    ...
    class Elevator : Solid
    {
        ...
        public void ExitRoom(Player player)
        {
            ...
            else
            {
                ...
                (XaphanModule.Instance._SaveData as XaphanModuleSaveData).TeleportFromElevator = true;
                CountdownDisplay timerDisplay = SceneAs<Level>().Tracker.GetEntity<CountdownDisplay>();
                if (timerDisplay != null)
                {
        ...
        {
            if (!(XaphanModule.Instance._SaveData as XaphanModuleSaveData).SavedFlags.Contains(Prefix + "_Chapter_" + currentChapter + "_Complete"))
            {
                (XaphanModule.Instance._SaveData as XaphanModuleSaveData).SavedFlags.Add(Prefix + "_Chapter_" + currentChapter + "_Complete");
            }
        }
    }
}
