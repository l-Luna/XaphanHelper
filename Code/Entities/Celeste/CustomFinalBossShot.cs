...
namespace Celeste.Mod.XaphanHelper.Entities
{
    [Pooled]
    [Tracked(false)]
    public class CustomFinalBossShot : Entity
    {
        ...
        public CustomFinalBossShot() : base(Vector2.Zero)
        {
        ...
        public CustomFinalBossShot Init(CustomFinalBoss boss, Player target, float angleOffset = 0f)
        {
            this.boss = boss;
        ...
        public CustomFinalBossShot InitAt(CustomFinalBoss boss, Vector2 target)
        {
            this.boss = boss;
            anchor = (Position = boss.Center);
            this.target = null;
        ...
        public override void Update()
        {
            ...
            if (!dead)
            {
                ...
                {
                    level.ParticlesFG.Emit(FinalBossShot.P_Trail, 1, base.Center, Vector2.One * 2f, particleDir);
                }
            }
        }
